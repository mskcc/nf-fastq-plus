...
workflow {
  ...
  demultiplex_wkflw( split_sample_sheet_wkflw.out.SPLIT_SAMPLE_SHEETS, split_sample_sheet_wkflw.out.RUN_TO_DEMUX_DIR, detect_runs_wkflw.out.RUNNAME,
    CELL_RANGER_ATAC, DEMUX_ALL, DATA_TEAM_EMAIL )
