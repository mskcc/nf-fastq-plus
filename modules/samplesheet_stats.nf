...
include { OTHER_create_sample_bams_wkflw } from './create_sample_bams';
...
workflow samplesheet_stats_wkflw {
  ...
  main:
    ...
    OTHER_create_sample_bams_wkflw( create_run_bams_wkflw.out.OUTPUT_ID, DEMUXED_DIR, ARCHIVED_DIR, STATS_DIR, STATSDONEDIR, CMD_FILE )
