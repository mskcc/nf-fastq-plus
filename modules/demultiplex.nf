...
include { demultiplex_bcl2fastq_task as stats_demultiplex_task } from './workflows/demultiplex_bcl2fastq_task'
include { demultiplex_bcl2fastq_task as reference_demultiplex_task } from './workflows/demultiplex_bcl2fastq_task'
include { demultiplex_dragen_task } from './workflows/demultiplex_dragen_task'
