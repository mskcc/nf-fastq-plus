...
SUBSAMPLE_AMOUNT=500
echo "Subsampling (only ${SUBSAMPLE_AMOUNT} reads - something very small)"
seqtk sample -s100 U0a_CGATGT_L001_R1_001.fastq.gz ${SUBSAMPLE_AMOUNT} > U0a_CGATGT_L001_R1_001_subsample.fastq.gz
rm U0a_CGATGT_L001_R1_001.fastq.gz

seqtk sample -s100 U0a_CGATGT_L001_R2_001.fastq.gz ${SUBSAMPLE_AMOUNT} > U0a_CGATGT_L001_R2_001_subsample.fastq.gz
