...
SAMPLESHEET=$(realpath ../../../bin/test/data/split_sampleSheet/split/SampleSheet_210421_ROSALIND_0004_FLOWCELLNAME.csv) \
  ...
  ../../../templates/bcl2fastq_demultiplex.sh > ${OUT_FILE}
...
rm bcl2fastq.log  # templates/bcl2fastq_demultiplex.sh writes a file locally, this is the bcl2fastq output (or echo here, so we need to delete this)
