...
PROCESSED_SAMPLE_SHEET = "/igo/home/igo/DividedSampleSheets"
COPIED_SAMPLE_SHEET = "/igo/home/igo/SampleSheetCopies"
...
def create_csv(top_of_sheet, sample_sheet, processed_dir, created_sample_sheets = None):
	...
	if (data_sheets[0].equals(no_data)) and (data_sheets[1].equals(no_data)) and (data_sheets[2].equals(no_data)) and (data_sheets[3].equals(no_data)):
		...
		print('NEW SAMPLE SHEETS LOCATED HERE = ' + processed_dir)
...
def main():
	...
	parser.add_argument('--source-dir', type = str, required = True, help = 'Directory where original sample sheets are')
	...
	copied_dir = args.source_dir
	processed_dir = args.processed_dir
	created_sample_sheets = args.output_file

	output="SAMPLE SHEET={}, COPY DIR={}, PROCESSED DIR={}".format(sample_sheet, copied_dir, processed_dir)
	if created_sample_sheets:
	...
	if dual_index:
		...
		create_csv(top_of_sheet, sample_sheet, processed_dir, created_sample_sheets)
