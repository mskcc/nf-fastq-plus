...
# !{RUN_PARAMS_FILE} is passed in, originating from detect_runs workflow
DETECT_RUNS_PARAMS=$(cat !{RUN_PARAMS_FILE})
rm !{RUN_PARAMS_FILE} # Remove this so that we start new
